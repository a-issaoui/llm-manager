...
class TestQuantizationType:
    ...
    def test_all_quant_types_exist(self):
        ...
        expected = ["F32", "F16", "Q4_0", "Q4_1", "Q5_0", "Q5_1", "Q8_0", 
                   "Q2_K", "Q3_K_S", "Q3_K_M", "Q3_K_L", "Q4_K_S", "Q4_K_M",
                   "Q5_K_S", "Q5_K_M", "Q6_K", "Q8_K", "IQ2_XXS", "IQ2_XS",
...
class TestGGUFReader:
    ...
    def test_read_value_unknown_type(self):
        """Test reading unknown type returns None."""
        from io import BytesIO
        
        f = BytesIO(b"data")
        result = GGUFReader.read_value(f, 999)  # Unknown type
        assert result is None
    
    def test_read_value_large_array(self):
        """Test reading large array returns summary."""
        import struct
        from io import BytesIO
        
        # Array of 2000 uint32s (larger than threshold)
        array_len = 2000
...
class TestParseParameters:
    ...
    def test_from_metadata(self):
        ...
        result = scanner.parse_parameters("7B", "model.gguf", metadata)
        assert result == 7.0
    ...
    def test_from_filename_pattern(self):
        ...
        scanner = PerfectScanner()
        metadata = {}
        result = scanner.parse_parameters("Unknown", "llama-7b-q4.gguf", metadata)
        assert result == 7.0
    ...
    def test_special_case_bge_m3(self):
        ...
        scanner = PerfectScanner()
        metadata = {}
        result = scanner.parse_parameters("Unknown", "bge-m3.gguf", metadata)
        assert result == 0.568
    ...
    def test_unknown_returns_none(self):
        ...
        scanner = PerfectScanner()
        metadata = {}
        result = scanner.parse_parameters("Unknown", "unknown_model.gguf", metadata)
        assert result is None
...
class TestDetectQuantization:
    ...
    def test_from_metadata(self):
        ...
        result = scanner.detect_quantization(metadata, "model.gguf")
        assert result == "Q4_0"
    ...
    def test_from_filename(self):
        ...
        scanner = PerfectScanner()
        metadata = {}
        result = scanner.detect_quantization(metadata, "model-q4_k_m.gguf")
...
class TestDetectCapabilities:
    ...
    def test_embedding_model(self):
        ...
        scanner = PerfectScanner()
        result = scanner.detect_capabilities("nomic-embed.gguf", "bert", {})
    ...
    def test_vision_model(self):
        ...
        result = scanner.detect_capabilities("llava.gguf", "llava", metadata)
    ...
    def test_reasoning_model(self):
        ...
        scanner = PerfectScanner()
        metadata = {"tokenizer.chat_template": ""}
        result = scanner.detect_capabilities("deepseek-r1.gguf", "llama", metadata)
    ...
    def test_tools_model(self):
        ...
        result = scanner.detect_capabilities("model-instruct.gguf", "llama", metadata)
...
class TestIsCustomTemplate:
    ...
    def test_custom_template(self):
        ...
        assert scanner.is_custom_template(template) is True
...
class TestFindParentModel:
    ...
    def test_fuzzy_match(self):
        ...
        # Add mock results
        specs = ModelSpecs(
            architecture="llava", quantization="Q4_K_M", size_label="7B",
            parameters_b=7.0, layer_count=32, context_window=4096, file_size_mb=100
        )
...
class TestScanModels:
    ...
    def test_basic_call(self, tmp_path):
        ...
        with patch('llm_manager.scanner.ModelScanner') as mock_class:
            mock_scanner = Mock()
...
class TestScanModelsAsync:
    ...
    async def test_async_wrapper(self, tmp_path):
        ...
        with patch('llm_manager.scanner.scan_models') as mock_scan:
            mock_scan.return_value = {"models_found": 5}
...
class TestCleanup:
    ...
    def test_removes_temp_files(self, tmp_path):
        ...
        import llm_manager.scanner as scanner_module
        ...
        original_list = scanner_module._temp_files.copy()
        scanner_module._temp_files.append(str(temp_file))
        ...
        try:
            ...
            scanner_module._temp_files.clear()
            scanner_module._temp_files.extend(original_list)
...
class TestMain:
    ...
    def test_basic_scan(self, tmp_path):
        ...
        with patch.object(sys, 'argv', ['scanner', str(tmp_path), '-o', str(tmp_path / 'out.json')]):
            result = main()
    ...
    def test_verbose_flag(self, tmp_path):
        ...
        with patch('llm_manager.scanner.logging.getLogger') as mock_get_logger:
            mock_logger = Mock()
...
class TestEdgeCases:
    ...
    def test_extract_specs_with_vocabulary_array(self, tmp_path):
        ...
        specs = scanner.extract_specs(str(fake_file), metadata, "llama")
...
class TestExtractSpecsComprehensive:
    ...
    def test_moe_model_detection(self, tmp_path):
        ...
        metadata = GGUFReader.extract_metadata(str(fake_file))
        specs = scanner.extract_specs(str(fake_file), metadata, "mixtral")
...
class TestModelScannerGetRegistry:
    ...
    def test_get_registry_success(self, tmp_path):
        ...
        with patch('llm_manager.scanner.ModelRegistry') as mock_registry_class:
            mock_registry = Mock()
    ...
    def test_generate_config_with_yaml(self, tmp_path):
        ...
        with patch('llm_manager.scanner.YAML_AVAILABLE', True):
            ...
            with patch('builtins.open', mock_open()) as m:
                ...
                m.assert_called_once_with(scanner.config_file, 'w')
